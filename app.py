...
def main():
    ...
    llm = ChatGroq(groq_api_key = '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',model = 'llama3-70b-8192')
    ...
    st.title("Yahoo Finance Stock Assistant")
    multiline_text = """
    Try asking "What's the current price of Meta stock?" or "Show me the historical prices of Apple vs Microsoft stock over the past 6 months.".
    """
